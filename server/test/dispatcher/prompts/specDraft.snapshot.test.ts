/**
 * Snapshot test for the spec_draft prompt template.
 *
...
import render from "../../../src/dispatcher/prompts/specDraft.js";
...
describe("specDraft template snapshot", () => {
