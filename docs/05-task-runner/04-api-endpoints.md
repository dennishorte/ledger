...
- ~~**422 vs 400 inconsistency between `docs.ts` and `tasks.ts`.** D7 chose 400 for this route; `routes/docs.ts:33` uses 422. Coordinated cleanup deferred. *(Priority: LOW.)*~~ *(Closed: 05-task-runner/99-maintenance/02-round-2, 2026-06-12.)*
