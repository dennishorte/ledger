...
Container for batched fixes to accumulated Open Issues across the `01-ui` subtree's COMPLETE leaves. The mechanism and rationale are defined once in [`../../../.ledger/process/maintenance-round.md`](../../_process/maintenance-round.md); this doc holds the rounds manifest and nothing else procedural.
