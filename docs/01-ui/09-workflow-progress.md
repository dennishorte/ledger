...
**Optional reference:** `01-ui/06-health` (same `parseDocs` + raw-markdown data pattern), `docs/_process/leaf-workflow.md` (canonical stage list and structural markers this node parses for)
