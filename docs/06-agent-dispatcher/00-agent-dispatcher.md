...
**Status:** COMPLETE
**Created:** 2026-05-28
**Last Updated:** 2026-06-06 (filed HIGH Open Issue — dispatched agent can hang indefinitely with no executor watchdog; see `docs/process/dispatcher-hang-issue.md`)
