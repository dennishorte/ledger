...
**Status:** COMPLETE
**Created:** 2026-05-28
**Last Updated:** 2026-06-06 (resolved the HIGH dispatcher-hang Open Issue — per-session MCP transports + watchdog + stream-json telemetry in `345dfaa`; see `docs/_investigations/dispatcher-hang-issue.md` §Resolution)
