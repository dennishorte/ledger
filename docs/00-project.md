...
| `11-workflow-scripts` | Workflow scripts — two `.claude/workflows/` JS scripts automating the leaf-workflow playbook (stages 1–8 in `leaf-workflow.js`; stages 9–11 in `leaf-workflow-finish.js`); idempotent re-entry; structured review output via sign-off matrix | `.ledger/process/leaf-workflow.md`, `05-task-runner/04-api-endpoints` | DRAFT (2026-06-10) |
