...
| `05-task-runner` | In-house task runner (tasks table, append-only event log, scheduler tick, HITL gates, resource claims; §5) | `04-api-server` | SPEC_REVIEW (parent doc authored 2026-05-27; decomposed into 5 children: `01-store-schema`, `02-scheduler`, `03-hitl-gate`, `04-api-endpoints`, `05-ui-hook-migration`, all PLANNED) |
