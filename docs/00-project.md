...
|----|-------|------------|--------|
| `01-ui` | UI — operator-facing surface for the framework | — | APPROVED (shell + 02-dag + 03-docs + 04-tasks + 06-health + 08-markdown + 09-workflow-progress + 10-orchestration COMPLETE; 05-logs VERIFY; 07-replay deferred) |
