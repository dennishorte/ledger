...
| `05-task-runner` | In-house task runner (tasks table, append-only event log, scheduler tick, HITL gates, resource claims; §5) | `04-api-server` | APPROVED (parent doc 2026-05-27; 1 of 5 children COMPLETE — `01-store-schema` (v1, 2026-05-27); `02-scheduler`, `03-hitl-gate`, `04-api-endpoints`, `05-ui-hook-migration` PLANNED) |
